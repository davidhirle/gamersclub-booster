...
const init = () => {
    ...
    watchSelect.innerHTML = `<input type="checkbox" ${checked} id="gc-booster-watchCheckbox" class="custom-checkbox  custom-form-btn-root"/>` +
                            '<label style="color: white; font-family: Poppins,sans-serif;" for="gc-booster-watchCheckbox">'+
                            '<span class="custom-form-btn custom-checkbox-btn"></span><i class="fa fa-eye" aria-hidden="true"></i> Ficar de olho</label>';
